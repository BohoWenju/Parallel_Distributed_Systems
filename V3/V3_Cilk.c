/*
  ...
  Main Code for V3 cilk of the exercise
...
//  algorithm in cilk implementation
void triangles_parallel_cilk_count(u_int32_t* indices, u_int32_t* indptr,int M){
  u_int32_t triangles=0;
  u_int32_t Cilk_array[M];
